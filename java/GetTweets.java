 ...
 * @email-id pxp1420330@utdallas.edu, sxm150231@utdallas.edu, sxd152930@utdallas.edu, vxj150030@utdallas.edu 
 * @version 1.0
 * 
...
public class GetTweets {
	...
	/*
	 * getTweet method usues the twitter credentials of the user to do a query on the topics - US Elections 2016 and the individual candidates
	 * @return: void
	 */
